 ...
 * <p>
 * The <G> type may either be an entity type or an input argument 
 * (non-entity) type.
 * <p>
 * Generally speaking, <code>null</code> input should produce <code>null</code> 
 * output for these transform methods.
 * 
