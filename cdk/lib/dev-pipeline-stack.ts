...
export class DevPipelineStack extends BaseStack {
  ...
  constructor(scope: cdk.Construct, props: IDevPipelineStackProps) {
    super(scope, "DevPipeline", props);
    ...
    const dockerBuild = new codebuild.PipelineProject(
      ...
      "DockerCodeBuildProject",
      {
        ...
        buildSpec: BuildSpec.fromObject({
          ...
          env: {
            variables: {
              REPOSITORY_URI: this.appRepository.repositoryUri
            },
            "parameter-store": {
          ...
          artifacts: {
            files: [
              "mcorpus-gql/target/awsdockerasset/imageTag.json",
            ],
            "discard-paths": "yes"
          }
        })
    ...
    const cdkBuild = new codebuild.PipelineProject(this, "CdkBuildProject", {
      ...
      buildSpec: BuildSpec.fromObject({
        ...
        artifacts: {
          ...
          files: ["mcorpus-App-DEV.template.json"]
        }
      })
    });
        ...
        },
        {
          ...
          actions: [
            new codepipeline_actions.CloudFormationCreateUpdateStackAction({
              ...
              stackName: "mcorpus-App-DEV",
              templatePath: cdkBuildOutput.atPath("mcorpus-App-DEV.template.json"),
