...
public class McuserLogout extends AbstractRoutine<Boolean> {
    ...
    private static final long serialVersionUID = -1689282387;
     ...
     */
    public static final Parameter<Timestamp> REQUEST_TIMESTAMP = createParameter("request_timestamp", org.jooq.impl.SQLDataType.TIMESTAMP, false, false);

    /**
     * The parameter <code>public.mcuser_logout.request_origin</code>.
     */
    public static final Parameter<String> REQUEST_ORIGIN = createParameter("request_origin", org.jooq.impl.SQLDataType.CLOB, false, false);
     ...
     */
    public void setRequestTimestamp(Field<Timestamp> field) {
