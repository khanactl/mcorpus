...
public class GetJwtStatus extends AbstractRoutine<JwtStatus> {
    ...
    private static final long serialVersionUID = -733777557;

    /**
     * The parameter <code>public.get_jwt_status.RETURN_VALUE</code>.
     */
    public static final Parameter<JwtStatus> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(com.tll.mcorpus.db.enums.JwtStatus.class), false, false);
     ...
     */
    public GetJwtStatus() {
        super("get_jwt_status", Public.PUBLIC, org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(com.tll.mcorpus.db.enums.JwtStatus.class));
