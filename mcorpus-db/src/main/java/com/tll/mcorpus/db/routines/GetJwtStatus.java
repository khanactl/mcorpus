...
public class GetJwtStatus extends AbstractRoutine<JwtStatus> {
    ...
    private static final long serialVersionUID = -164059446;

    /**
     * The parameter <code>public.get_jwt_status.RETURN_VALUE</code>.
     */
    public static final Parameter<JwtStatus> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(com.tll.mcorpus.db.enums.JwtStatus.class), false, false);
