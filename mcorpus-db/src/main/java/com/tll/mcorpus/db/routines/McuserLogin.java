...
public class McuserLogin extends AbstractRoutine<McuserAndRolesRecord> {
    ...
    private static final long serialVersionUID = 1867537419;

    /**
     * The parameter <code>public.mcuser_login.RETURN_VALUE</code>.
     */
    public static final Parameter<McuserAndRolesRecord> RETURN_VALUE = createParameter("RETURN_VALUE", com.tll.mcorpus.db.udt.McuserAndRoles.MCUSER_AND_ROLES.getDataType(), false, false);
