...
public class MemberAuditRecord extends TableRecordImpl<MemberAuditRecord> implements Record5<UUID, Timestamp, MemberAuditType, Timestamp, String> {

    private static final long serialVersionUID = -2113277578;
