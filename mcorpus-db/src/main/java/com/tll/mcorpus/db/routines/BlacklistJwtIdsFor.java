...
public class BlacklistJwtIdsFor extends AbstractRoutine<java.lang.Void> {
    ...
    private static final long serialVersionUID = 1881014440;

    /**
     * The parameter <code>public.blacklist_jwt_ids_for.uid</code>.
     */
    public static final Parameter<UUID> UID = Internal.createParameter("uid", org.jooq.impl.SQLDataType.UUID, false, false);
