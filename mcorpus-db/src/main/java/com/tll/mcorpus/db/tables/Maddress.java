...
public class Maddress extends TableImpl<MaddressRecord> {
    ...
    private static final long serialVersionUID = 1459490062;
     ...
     */
    public final TableField<MaddressRecord, Addressname> ADDRESS_NAME = createField("address_name", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(com.tll.mcorpus.db.enums.Addressname.class), this, "");
