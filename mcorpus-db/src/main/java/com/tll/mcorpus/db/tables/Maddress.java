...
public class Maddress extends TableImpl<MaddressRecord> {
    ...
    private static final long serialVersionUID = -445276281;
     ...
     */
    public final TableField<MaddressRecord, UUID> MID = createField("mid", org.jooq.impl.SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>public.maddress.address_name</code>.
     */
    public final TableField<MaddressRecord, Addressname> ADDRESS_NAME = createField("address_name", org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.tll.mcorpus.db.enums.Addressname.class), this, "");
     ...
     */
    public final TableField<MaddressRecord, String> ATTN = createField("attn", org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>public.maddress.street1</code>.
     */
    public final TableField<MaddressRecord, String> STREET1 = createField("street1", org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.maddress.street2</code>.
     */
    public final TableField<MaddressRecord, String> STREET2 = createField("street2", org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>public.maddress.city</code>.
     */
    public final TableField<MaddressRecord, String> CITY = createField("city", org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.maddress.state</code>.
     */
    public final TableField<MaddressRecord, String> STATE = createField("state", org.jooq.impl.SQLDataType.CHAR(2).nullable(false), this, "");

    /**
     * The column <code>public.maddress.postal_code</code>.
     */
    public final TableField<MaddressRecord, String> POSTAL_CODE = createField("postal_code", org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>public.maddress.country</code>.
     */
    public final TableField<MaddressRecord, String> COUNTRY = createField("country", org.jooq.impl.SQLDataType.CLOB.nullable(false).defaultValue(org.jooq.impl.DSL.field("'USA'::text", org.jooq.impl.SQLDataType.CLOB)), this, "");
