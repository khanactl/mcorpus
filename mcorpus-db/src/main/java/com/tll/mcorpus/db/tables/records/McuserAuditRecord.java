...
public class McuserAuditRecord extends UpdatableRecordImpl<McuserAuditRecord> implements Record8<UUID, Timestamp, McuserAuditType, Timestamp, String, Timestamp, UUID, JwtStatus> {

    private static final long serialVersionUID = -284767981;
     ...
     */
    @Override
    public Row8<UUID, Timestamp, McuserAuditType, Timestamp, String, Timestamp, UUID, JwtStatus> fieldsRow() {
     ...
     */
    @Override
    public Row8<UUID, Timestamp, McuserAuditType, Timestamp, String, Timestamp, UUID, JwtStatus> valuesRow() {
     ...
     */
    @Override
    public McuserAuditRecord value8(JwtStatus value) {
     ...
     */
    @Override
    public McuserAuditRecord values(UUID value1, Timestamp value2, McuserAuditType value3, Timestamp value4, String value5, Timestamp value6, UUID value7, JwtStatus value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public McuserAuditRecord(UUID uid, Timestamp created, McuserAuditType type, Timestamp requestTimestamp, String requestOrigin, Timestamp loginExpiration, UUID jwtId, JwtStatus jwtIdStatus) {
        super(McuserAudit.MCUSER_AUDIT);
