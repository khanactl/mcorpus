...
public class Mref extends UDTImpl<MrefRecord> {
    ...
    private static final long serialVersionUID = 1316031830;
     ...
     */
    public static final UDTField<MrefRecord, Location> LOCATION = createField("location", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(com.tll.mcorpus.db.enums.Location.class), MREF, "");
