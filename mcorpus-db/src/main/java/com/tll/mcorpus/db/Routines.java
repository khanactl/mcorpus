...
public class Routines {
     ...
     */
    public static void blacklistJwtIdsFor(Configuration configuration, UUID inUid, OffsetDateTime inRequestTimestamp, InetAddress inRequestOrigin) {
     ...
     */
    public static McuserRecord mcuserLogin(Configuration configuration, String mcuserUsername, String mcuserPassword, OffsetDateTime inRequestTimestamp, InetAddress inRequestOrigin, OffsetDateTime inLoginExpiration, UUID inJwtId) {
     ...
     */
    public static Field<McuserRecord> mcuserLogin(String mcuserUsername, String mcuserPassword, OffsetDateTime inRequestTimestamp, InetAddress inRequestOrigin, OffsetDateTime inLoginExpiration, UUID inJwtId) {
        McuserLogin f = new McuserLogin();
        f.setMcuserUsername(mcuserUsername);
        f.setMcuserPassword(mcuserPassword);
        f.setInRequestTimestamp(inRequestTimestamp);
     ...
     * Get <code>public.mcuser_login</code> as a field.
     */
    public static Field<McuserRecord> mcuserLogin(Field<String> mcuserUsername, Field<String> mcuserPassword, Field<OffsetDateTime> inRequestTimestamp, Field<InetAddress> inRequestOrigin, Field<OffsetDateTime> inLoginExpiration, Field<UUID> inJwtId) {
        McuserLogin f = new McuserLogin();
        f.setMcuserUsername(mcuserUsername);
        f.setMcuserPassword(mcuserPassword);
        f.setInRequestTimestamp(inRequestTimestamp);
     ...
     */
    public static Boolean mcuserLogout(Configuration configuration, UUID mcuserUid, UUID jwtId, OffsetDateTime requestTimestamp, InetAddress requestOrigin) {
     ...
     */
    public static Field<Boolean> mcuserLogout(UUID mcuserUid, UUID jwtId, OffsetDateTime requestTimestamp, InetAddress requestOrigin) {
        McuserLogout f = new McuserLogout();
        f.setMcuserUid(mcuserUid);
        f.setJwtId(jwtId);
        f.setRequestTimestamp(requestTimestamp);
     ...
     * Get <code>public.mcuser_logout</code> as a field.
     */
    public static Field<Boolean> mcuserLogout(Field<UUID> mcuserUid, Field<UUID> jwtId, Field<OffsetDateTime> requestTimestamp, Field<InetAddress> requestOrigin) {
        McuserLogout f = new McuserLogout();
        f.setMcuserUid(mcuserUid);
        f.setJwtId(jwtId);
        f.setRequestTimestamp(requestTimestamp);
     ...
     */
    public static MrefRecord memberLogin(Configuration configuration, String memberUsername, String memberPassword, OffsetDateTime inRequestTimestamp, InetAddress inRequestOrigin) {
     ...
     */
    public static Field<MrefRecord> memberLogin(String memberUsername, String memberPassword, OffsetDateTime inRequestTimestamp, InetAddress inRequestOrigin) {
        MemberLogin f = new MemberLogin();
        f.setMemberUsername(memberUsername);
        f.setMemberPassword(memberPassword);
        f.setInRequestTimestamp(inRequestTimestamp);
     ...
     * Get <code>public.member_login</code> as a field.
     */
    public static Field<MrefRecord> memberLogin(Field<String> memberUsername, Field<String> memberPassword, Field<OffsetDateTime> inRequestTimestamp, Field<InetAddress> inRequestOrigin) {
        MemberLogin f = new MemberLogin();
        f.setMemberUsername(memberUsername);
        f.setMemberPassword(memberPassword);
        f.setInRequestTimestamp(inRequestTimestamp);
     ...
     */
    public static UUID memberLogout(Configuration configuration, UUID mid, OffsetDateTime inRequestTimestamp, InetAddress inRequestOrigin) {
     ...
     */
    public static Field<UUID> memberLogout(UUID mid, OffsetDateTime inRequestTimestamp, InetAddress inRequestOrigin) {
        MemberLogout f = new MemberLogout();
        f.setMid(mid);
        f.setInRequestTimestamp(inRequestTimestamp);
        f.setInRequestOrigin(inRequestOrigin);
     ...
     * Get <code>public.member_logout</code> as a field.
     */
    public static Field<UUID> memberLogout(Field<UUID> mid, Field<OffsetDateTime> inRequestTimestamp, Field<InetAddress> inRequestOrigin) {
        MemberLogout f = new MemberLogout();
        f.setMid(mid);
        f.setInRequestTimestamp(inRequestTimestamp);
        f.setInRequestOrigin(inRequestOrigin);
