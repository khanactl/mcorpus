...
public class Mbenefits extends TableImpl<MbenefitsRecord> {
    ...
    private static final long serialVersionUID = 785105397;
     ...
     */
    public final TableField<MbenefitsRecord, Beli> BELI = createField("beli", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(com.tll.mcorpus.db.enums.Beli.class), this, "");

    /**
     * The column <code>public.mbenefits.mcb</code>.
     */
    public final TableField<MbenefitsRecord, BigDecimal> MCB = createField("mcb", org.jooq.impl.SQLDataType.NUMERIC.nullable(false), this, "");
