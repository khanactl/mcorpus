...
public class McuserRecord extends UpdatableRecordImpl<McuserRecord> implements Record9<UUID, Timestamp, Timestamp, String, String, String, String, Boolean, McuserStatus> {

    private static final long serialVersionUID = 2122757329;
     ...
     */
    @Override
    public Row9<UUID, Timestamp, Timestamp, String, String, String, String, Boolean, McuserStatus> fieldsRow() {
     ...
     */
    @Override
    public Row9<UUID, Timestamp, Timestamp, String, String, String, String, Boolean, McuserStatus> valuesRow() {
     ...
     */
    @Override
    public Field<McuserStatus> field9() {
     ...
     */
    @Override
    public McuserStatus component9() {
        return getStatus();
    }
     ...
     */
    @Override
    public McuserRecord value9(McuserStatus value) {
        setStatus(value);
        return this;
    }
     ...
     */
    @Override
    public McuserRecord values(UUID value1, Timestamp value2, Timestamp value3, String value4, String value5, String value6, String value7, Boolean value8, McuserStatus value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public McuserRecord(UUID uid, Timestamp created, Timestamp modified, String name, String email, String username, String pswd, Boolean admin, McuserStatus status) {
        super(Mcuser.MCUSER);
