...
public class McuserRecord extends UpdatableRecordImpl<McuserRecord> implements Record9<UUID, Timestamp, Timestamp, String, String, String, String, McuserStatus, McuserRole[]> {
    ...
    private static final long serialVersionUID = -645283436;
     ...
     */
    public McuserRecord(UUID uid, Timestamp created, Timestamp modified, String name, String email, String username, String pswd, McuserStatus status, McuserRole[] roles) {
        super(Mcuser.MCUSER);
