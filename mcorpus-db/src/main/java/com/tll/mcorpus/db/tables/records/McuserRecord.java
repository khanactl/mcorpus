...
public class McuserRecord extends UpdatableRecordImpl<McuserRecord> implements Record8<UUID, Timestamp, Timestamp, String, String, String, String, Boolean> {

    private static final long serialVersionUID = -1362235004;
     ...
     */
    @Override
    public Row8<UUID, Timestamp, Timestamp, String, String, String, String, Boolean> fieldsRow() {
     ...
     */
    @Override
    public Row8<UUID, Timestamp, Timestamp, String, String, String, String, Boolean> valuesRow() {
     ...
     */
    @Override
    public McuserRecord values(UUID value1, Timestamp value2, Timestamp value3, String value4, String value5, String value6, String value7, Boolean value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public McuserRecord(UUID uid, Timestamp created, Timestamp modified, String name, String email, String username, String pswd, Boolean admin) {
        super(Mcuser.MCUSER);
