...
-- NOTE: we grant delete privileges to mcweb user on mcuser and member audit tables
--       to support table locking
...
grant select on member_audit to mcweb;
grant insert, delete on member_audit to mcweb;
-- mcuser related
grant select on mcuser, mcuser_audit to mcweb;
grant insert, update, delete on mcuser to mcweb;
grant insert, delete on mcuser_audit to mcweb;
